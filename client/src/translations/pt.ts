export const pt = {
  ...
  admin: {
    ...
    createBackupDescription: 'Exporte os dados do sistema para backup',
    backupOptions: 'Opções de Backup',
    backupUsers: 'Usuários',
    backupFarms: 'Fazendas',
    backupAnimals: 'Animais',
    backupCrops: 'Plantações',
    backupInventory: 'Inventário',
    backupTasks: 'Tarefas',
    restoreBackupDescription: 'Restaure dados a partir de um arquivo de backup',
    selectBackupFile: 'Selecione o arquivo de backup',
    chooseFile: 'Escolher arquivo',
    restoreOptions: 'Opções de Restauração',
    restoreMerge: 'Mesclar com dados existentes',
    restoreOverwrite: 'Sobrescrever dados existentes',

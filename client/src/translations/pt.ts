export const pt = {
  ...
  inventory: {
    ...
    enterQuantity: 'Informe a quantidade a adicionar',
    notes: 'Observações (opcional)',
    restock: 'Repor',
    restockSuccess: 'Item reposto com sucesso',
    restockSuccessDescription: 'O inventário foi atualizado com a nova quantidade',
    restockError: 'Falha ao repor o item do inventário',
    criticalItems: 'Nível Crítico',
    categories: {
      feed: 'Alimentação',
